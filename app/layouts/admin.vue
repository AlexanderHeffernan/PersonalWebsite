...
const navItems = [
  ...
  { path: '/admin/streaks', label: 'Streaks', icon: 'calendar' },
]
      ...
      <div class="admin-sidebar__content">
        ...
        <nav class="admin-nav">
          ...
          >
            ...
            <svg v-else-if="item.icon === 'calendar'" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
